...
import { FaTachometerAlt, FaClipboardList, FaUtensils, FaHome, FaSeedling, FaChartBar } from "react-icons/fa";
      ...
      <aside className="w-64 bg-white shadow-md flex flex-col justify-between">
        <div className="p-6">
          <nav className="flex flex-col gap-2">
            ...
            <NavLink to="/admin/sales-stats" className={navLinkClass}>
              <FaChartBar /> Sales Stats
            </NavLink>
